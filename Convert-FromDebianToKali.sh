...
sudo DEBIAN_FRONTEND=noninteractive TZ=Etc/UTC apt-get install --quiet=2 --assume-yes --no-install-recommends ca-certificates curl dirmngr gnupg
...
sudo DEBIAN_FRONTEND=noninteractive TZ=Etc/UTC apt-get update  --quiet=2 --assume-yes --no-install-recommends
sudo DEBIAN_FRONTEND=noninteractive TZ=Etc/UTC apt-get upgrade --quiet=2 --assume-yes --no-install-recommends
sudo DEBIAN_FRONTEND=noninteractive TZ=Etc/UTC apt-get install --quiet=2 --assume-yes --no-install-recommends kali-defaults kali-linux-headless
